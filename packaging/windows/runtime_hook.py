# Phase 44 MusicStreamer — custom runtime hook.
# Copied verbatim from .planning/phases/43-gstreamer-windows-spike/runtime_hook.py per D-17.
...
# --- Diagnostics marker --------------------------------------------------
# Printed to stderr so the build/UAT log can grep it.
# Stable prefix "MUSICSTREAMER_DIAG_RTHOOK" so the build log + UAT scripts can grep it.
print(
    f"MUSICSTREAMER_DIAG_RTHOOK gio_extra_modules={os.environ['GIO_EXTRA_MODULES']!r} "
