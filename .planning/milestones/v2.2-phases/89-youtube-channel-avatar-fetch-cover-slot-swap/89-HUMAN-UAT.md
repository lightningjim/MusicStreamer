...
result: pass
note: "Initially failed (stuck at 'Fetching avatar…'); fixed via playlist_items='0' + socket_timeout + shutdown wait escalation, then retested — works nicely, approved."
