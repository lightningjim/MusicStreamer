...
Plans:
- [x] 11-01-PLAN.md — CSS provider with gradient+rounded panel, increased margins, station row padding bump
- [x] 11-02-PLAN.md — Fix station art border-radius clipping (GTK4: set_overflow(HIDDEN) required alongside CSS)
