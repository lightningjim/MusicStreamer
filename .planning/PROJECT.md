...
*Backlog bugs (six v2.0-era stubs in `.planning/phases/`):*
- 999.2 — Recently played list does not update live
- 999.4 — Cross-network mirror station sibling links (AudioAddict)
- 999.5 — EQ toggle brief audio dropout
- 999.6 — Merge YouTube cookies menu into accounts menu
- 999.10 — Radio logo view: rectangular logos cut off (square-only crop)
- 999.11 — Edit station save re-closes all expanded sections
...
- Backlog 999.12 — PLS auto-resolve into N stream entries (deferred Phase 49 work)
...
Requirements for v2.1 live in `.planning/REQUIREMENTS.md` (generated by the roadmap cycle). Core direction: close out the six v2.0 backlog bug stubs, ship the Phase 44 Windows polish carry-forward, harvest the two dormant seeds (visual color picker + GBS-FM), and absorb new bugs/improvements as they surface from daily use. Rolling milestone — phases added throughout via `/gsd-add-phase`.
