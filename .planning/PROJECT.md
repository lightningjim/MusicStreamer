...
Requirements for v2.0 live in `.planning/REQUIREMENTS.md` (generated by the roadmap cycle). Core direction: Qt/PySide6 port to Windows + Linux, feature-parity with v1.5, manual settings export/import, cross-platform media keys, Windows installer.
