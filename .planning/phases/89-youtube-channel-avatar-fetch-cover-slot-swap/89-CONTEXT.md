...
- **D-01:** Avatar auto-fetches on **debounced URL paste/edit** in `EditStationDialog` (~600ms after the URL field settles), matching the Phase 6/17 YT-thumbnail auto-fetch precedent. Not on Save/OK, not on every keystroke. Satisfies ART-AVATAR-05's "auto-fetch on paste".
