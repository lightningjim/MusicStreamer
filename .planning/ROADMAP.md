...
Plans:
- [ ] 60.1-01-PLAN.md — Wave 0 RED: capture multi-word fixture (D-03) + 13 RED tests (parser + dialog) + extend gbs_capture_fixtures.sh
- [ ] 60.1-02-PLAN.md — Wave 1 GREEN: D-04 multi-word fix + Pitfall 7 docstring + _ArtistPageParser + _AlbumPageParser (D-02 belt-and-suspenders) + fetch_artist_songs + fetch_album_songs
