...
Plans:
- [ ] 72.4-01-PLAN.md — Wave 0 TDD-RED scaffold (tests/test_phase72_4_volume_cluster_reflow.py 13 behavior + 3 negatives) + REQUIREMENTS.md LAYOUT-04 registration
- [ ] 72.4-02-PLAN.md — Wave 1 GREEN helpers: _row1_min_cache dict + _volume_cluster_row1_index capture + generalized _row1_min_width(include_picker, include_volume_cluster) + _move_volume_cluster_to + _set_volume_size_policy (canonical Qt 6 three-call round-trip)
