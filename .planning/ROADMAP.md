...
- [ ] 36-02-PLAN.md — Extract pure URL helpers from ui/edit_dialog.py to url_helpers.py and rewire tests (safety valve before GTK delete)
...
| 36. Qt Scaffold + GTK Cutover | v2.0 | 1/4 | In Progress|  |
